...
<template>
    <div
        class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border border-gray-100 hover:border-indigo-200 transform hover:-translate-y-1">
        ...
        <div class="flex justify-between items-start mb-5">
            <div class="flex-1">
                ...
                <div class="flex items-center gap-2">
                    <span
                        class="inline-flex items-center bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-700 px-3 py-1.5 rounded-full text-xs font-semibold">
